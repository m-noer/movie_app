...
class _PopularTvPageState extends State<PopularTvPage> {
  //* Cubit
  final _tvPopularCubit = sl<TvShowPopularCubit>();
  ...
  void getListMovies(int pageKey) {
    ...
    _tvPopularCubit.getTvShowPopular(params);
  }

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => _tvPopularCubit,
      child: BlocListener<TvShowPopularCubit, TvShowPopularState>(
